...
class CleanService : AccessibilityService() {
    ...
    override fun onServiceConnected() {
        ...
        val intent = Intent()
        intent.setClassName("com.supers.cleaner.phonemaster", "com.supers.cleaner.phonemaster.MainActivity")
    ...
    override fun onStartCommand(prevIntent: Intent?, flags: Int, startId: Int): Int {
        ...
        returnToHome = Runnable {
            ...
            intent.setClassName("com.supers.cleaner.phonemaster", "com.supers.cleaner.phonemaster.Scanning_Junk")
            intent.action = Intent.ACTION_MAIN
